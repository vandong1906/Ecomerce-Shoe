                ...
                <div className="md:w-1/2 md:pl-8">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="mt-2 flex flex-wrap space-x-2">
                            <button className="mb-2 rounded-full border border-gray-300 px-4 py-2 hover:scale-105 hover:bg-blue-500/25">40.5</button>
                            <button className="mb-2 rounded-full border border-gray-300 px-4 py-2 hover:scale-105 hover:bg-blue-500/25">41</button>
                            <button className="mb-2 rounded-full border border-gray-300 px-4 py-2 hover:scale-105 hover:bg-blue-500/25">42</button>
                            <button className="mb-2 rounded-full border border-gray-300 px-4 py-2 hover:scale-105 hover:bg-blue-500/25">42.5</button>
                            <button className="mb-2 rounded-full border border-gray-300 px-4 py-2 hover:scale-105 hover:bg-blue-500/25">43</button>
                            <button className="mb-2 rounded-full border border-gray-300 px-4 py-2 hover:scale-105 hover:bg-blue-500/25">44</button>
                        </div>
                    </div>
                    ...
                    <div className="mb-4 flex flex-col space-y-2 md:flex-row md:space-x-2 md:space-y-0">
                        <button className="w-full rounded bg-red-500 py-3 text-white transition-all duration-700 hover:scale-105 hover:shadow-2xl md:w-1/3">MUA NGAY<br />Giao Tận Nơi Hoặc Nhận Tại Cửa Hàng</button>
                        <button className="w-full rounded bg-blue-500 py-3 text-white transition-all duration-700 hover:scale-105 hover:shadow-2xl md:w-1/3">TRẢ GÓP QUA THẺ<br />Visa, Master, JCB</button>
                        <button className="w-full rounded bg-yellow-500 py-3 text-white transition-all duration-700 hover:scale-105 hover:shadow-2xl md:w-1/3">MUA NGAY - TRẢ SAU<br />HOME PayLater</button>
                    </div>
                    <ul className="grid grid-cols-2 space-y-2 text-sm text-gray-500">
                        <li><button className="hover:text-blue-700/75">Hệ Thống Cửa Hàng</button></li>
                        <li><button className="hover:text-blue-700/75">Cam Kết Khách Hàng</button></li>
                        <li><button className="hover:text-blue-700/75">Chính Sách Đổi Trả, Bảo Hành</button></li>
                        <li><button className="hover:text-blue-700/75">Chính Sách Vận Chuyển</button></li>
                    </ul>
                </div>
            </div>
        </div>
