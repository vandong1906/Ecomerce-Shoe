...
function ManagingProduct() {
    ...
    return <>
        <div className="flex mt-16">
            <form className="w-1/3 mx-auto" onSubmit={(e) => handlerProduct(e)} encType="multipart/form-data">
                ...
                <div className="relative">
                    ...
                    <label htmlFor="floating_outlined"
                        className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Name Product</label>
                </div>
                ...
                <div className="flex items-center justify-center w-full py-6">
                    <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                        ...
                        <input id="dropzone-file" type="file" className="hidden" name="file[]" multiple
                            onChange={
                                (e) => {
                ...
                <div className="flex items-center justify-center w-full py-6 gap-5"> 
                {
                    ...
                    file?.map((file, index) => (
                        console.log(file),
                        <img src={URL.createObjectURL(file)} alt="#" className="w-24" />
                    )
                    )
                }
                </div>
